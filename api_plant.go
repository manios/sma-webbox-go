...
/* 
PlantApiService Photovoltaic plant Overview values
Returns an object with the following plant data:&lt;ul&gt;&lt;li&gt;POWER&lt;/li&gt;&lt;li&gt;DAILY-YIELD&lt;/li&gt;&lt;li&gt;TOTAL-YIELD&lt;/li&gt;&lt;li&gt;STATUS&lt;/li&gt;&lt;li&gt;ERROR&lt;/li&gt;&lt;/ul&gt;
...
func (a *PlantApiService) GetPlantOverview(ctx context.Context, rpcbody GenericRequest) (PlantOverviewResponse, *http.Response, error) {
	var (
		...
		localVarReturnValue PlantOverviewResponse
	)
